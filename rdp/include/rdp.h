...
RDP_API i32 rdp_socket_connect(RDPSOCKET sock, const char* ip, ui32 port, ui32 timeout,
    RDPSESSIONID* session_id, const ui8* buf = 0, ui16 buf_len = 0);
...
RDP_API i32 rdp_session_send(RDPSOCKET sock, RDPSESSIONID session_id, const ui8* buf, ui16 buf_len,
                             ui32 flags,//RDPSESSIONSENDFLAG
